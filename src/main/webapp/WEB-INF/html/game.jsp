...
<table width="50%">
    <thead></thead>
    <tbody>
        <tr> <th><label id = "sq11"/></th> <th><label id = "sq12"/></th> <th><label id = "sq13"/></th> <th><label id = "sq14"/></th> <th><label id = "sq15"/></th> <th><label id = "sq16"/></th> <th><label id = "sq17"/></th> <th><label id = "sq18"/></th> <th><label id = "sq19"/></th> <th><label id = "sq110"/></th> </tr>
